...
write_tsv(as.data.frame(assay(InputHumannData.tse, "AbsAbund")), "Data/humann_data/humann3.9_unstratified_AbsCounts_raw.tsv")
...
## UNSCALED and UNINTEGRATED reads vary with Microbiome
...
UNINTEGRATED: Reads did map into a gene-gene family, BUT but that gene-gene famly was not in the pathways database
```

Is it generally true that unmapped and unintegrated have opposite trends?
...
Conclusion: Wild mice have a tendency to have more 2% or more unmapped reads.
